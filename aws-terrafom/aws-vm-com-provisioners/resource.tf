...
resource "aws_instance" "vm" {
  ...
  subnet_id                   = data.terraform_remote_state.vpc.outputs.subnet_public_id
  vpc_security_group_ids      = [data.terraform_remote_state.vpc.outputs.security_group_public_id]
